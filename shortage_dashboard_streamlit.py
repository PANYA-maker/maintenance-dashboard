...
with left:
    ...
    if not top10.empty:
        ...
        fig_top10.update_traces(textposition="inside", insidetextanchor="end", textfont=dict(color="white", size=13))
...
st.caption("Shortage Dashboard | FINAL PROD VERSION | Complete Build")
