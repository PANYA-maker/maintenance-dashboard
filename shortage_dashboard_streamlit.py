...
required_cols = ["สถานะผลิต", "สถานะซ่อมสรุป", "น้ำหนักของเหลือ PDW"]

if all(col in fdf.columns for col in required_cols):

    # ✅ เลือกเฉพาะงานที่ "ขาดจำนวน"
    shortage_df = fdf[
    ...
    if not shortage_df.empty:
        ...
        issue_summary = (
            ...
            .agg(
                จำนวน=("สถานะผลิต", "count"),          # ✅ นับจากสถานะผลิต
    ...
    st.warning(
        f"ไม่พบคอลัมน์ที่จำเป็น: {required_cols}"
    )
